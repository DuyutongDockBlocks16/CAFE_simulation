...
plt.rcParams['xtick.labelsize'] = 25    # X轴刻度标签
plt.rcParams['ytick.labelsize'] = 25    # Y轴刻度标签
plt.rcParams['axes.labelsize'] = 25    # 坐标轴标签（xlabel, ylabel）
plt.rcParams['font.size'] = 25          # 基础字体大小

LOG_NAME = "driver_episode_data_20250917_120511.jsonl"
# LOG1_NAME = "driver_episode_data_20250917_120511.jsonl"
# LOG2_NAME = "driver_episode_data_20250919_134832.jsonl"
# LOG3_NAME = "driver_episode_data_20250920_155212.jsonl"
# LOG4_NAME = "driver_episode_data_20250920_190030.jsonl"
# LOG5_NAME = "driver_episode_data_20250920_195253.jsonl"
# LOG6_NAME = "driver_episode_data_20250920_212641.jsonl"
# LOG7_NAME = "driver_episode_data_20250922_100256.jsonl"
# LOG8_NAME = "driver_episode_data_20250922_141502.jsonl"
# LOG9_NAME = "driver_episode_data_20250922_184926.jsonl"
...
def plot_episode_analysis(episodes, metadata=None, final_metadata=None, save_path=None, max_episodes=6200):
    """
    ...
    if max_episodes is not None and len(episodes) > max_episodes:
        ...
        print(f"📊 Limiting plot to first {max_episodes} episodes (out of {len(episodes)} total)")
    ...
    # 计算移动平均线
    moving_avg_rewards = calculate_moving_average(total_rewards, window_size=700)
    
    # Create figure with subplots
    # fig, ((ax1, ax2), (ax3, ax4)) = plt.subplots(2, 2, figsize=(15, 12))
    fig, ax1 = plt.subplots(1, 1, figsize=(15, 12))
    fig.suptitle('Average Episode Reward', fontsize=25, fontweight='bold')
    ...
    ax1.plot(episode_numbers, moving_avg_rewards, 'r-', linewidth=3, 
             label='Moving Average (200 episodes)', alpha=0.9)
...
def main():
    ...
    # Create plot
    save_path = filename.replace('.jsonl', '_analysis_theis.png')

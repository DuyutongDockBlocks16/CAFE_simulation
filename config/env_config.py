...
class RLRobotFiniteState(Enum):
    ...
    WAIT_FOR_FINISH = 6
    PLACING_OBJECT_UPPER = 7
    PLACING_OBJECT_LOWER = 8
    MAKE_DECISION_ON_PLACING_POSITION = 9
    NAVIGATE_TO_PLACING_POSITION_1 = 10
    NAVIGATE_TO_PLACING_POSITION_2 = 11
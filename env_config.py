...
class FiniteState(Enum):
    ...
    PLACING_AT_LAYER = 12
    JOINT2_JOINT5_TO_UPPER_LAYER = 13
    WAITING_JOINT2_JOINT5_TO_UPPER_LAYER = 14
    JOINT2_JOINT3_JOINT5_TO_UPPER_LAYER = 15
    WAITING_JOINT2_JOINT3_JOINT5_TO_UPPER_LAYER = 16

...
gym.register(
    id="CollabFsmHybridMuJoCoEnv-v0",
    entry_point="collab_fsm_hybrid_robot_env:CollabFsmHybridMuJoCoEnv",
    # kwargs={
...
if __name__ == "__main__":
    driver_env = gym.make("CollabFsmHybridMuJoCoEnv-v0")

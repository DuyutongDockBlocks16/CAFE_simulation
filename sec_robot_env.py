...
ACTION_SPACE_REDUCTION = 10  # Number of actuators to be reduced from the action space
...
class SecondRobotMuJoCoEnv(gym.Env):
    ...
    def step(self, action):  
        ...
        if self.check_robot_distance_violation():
    ...
    def check_robot_distance_violation(self):
        ...
        if self.robot1_rover_id is None or self.robot2_rover_id is None:
            return False
